    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Tablas de Aspirantes</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Tablas de Aspirantes</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    ?>  
                      <tr>
                        ...
                        <td><?php echo $fila['bachillerato'];?></td>
                        <td><?php echo $fila['promedio'];?></td>
                        <td><?php echo $fila['municipio'];?></td>
                        <td><?php echo $fila['certificado'];?></td>
                        <td><img src ="xampp/htdocs/PRACTICA/images/<?php echo $fila['foto'];?>"></td>
                      </tr>
                    <?php 
                      }
                    ?>
