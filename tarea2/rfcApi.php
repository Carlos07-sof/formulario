        ...
        $(document).ready(function () {
            $('#ejecutar').click(function () {
                ...
                if ($('#valor1').val() == "" || $('#valor1').val() == "Nombre" || $('#valor2').val() == "" || $('#valor2').val() == "Apellido Paterno" ||  $('#valor3').val() == "" || $('#valor3').val() == "Apellido Materno" || $('#start').val() == "") {
                   ...
                   cadena1 = $('#valor2').val().substring(0,2);
                   cadena2 = $('#valor3').val().substring(0,1);
                   cadena3 = $('#valor1').val().substring(0,1);
                ...
                $('#resultado').val(cadena1.toUpperCase()+cadena2.toUpperCase()+cadena3.toUpperCase()+año+result1);
            });
